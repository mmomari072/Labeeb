...
> 📖 **Comprehensive Guide**: See the complete [v1.22.0 User Manual & API Guide](docs/USER_MANUAL.md) for in-depth examples covering declarative harvesters, coupling stability controls, and non-blocking shared campaign memory.
